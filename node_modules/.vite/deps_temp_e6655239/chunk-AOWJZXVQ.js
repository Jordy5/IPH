  ...
  "node_modules/hoist-non-react-statics/node_modules/react-is/cjs/react-is.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function isValidElementType4(type) {
        ...
        exports.isValidElementType = isValidElementType4;
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React35.Fragment, {
...
function createGrid(options = {}) {
  ...
  const Grid2 = React38.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React38.Children.map(children, (child) => {
        var _a;
        if (React38.isValidElement(child) && isMuiElement2(child, ["Grid"]) && container && child.props.container) {
...
function createStack(options = {}) {
  ...
  const Stack2 = React39.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
function deepClone2(source) {
  if (React40.isValidElement(source) || (0, import_react_is5.isValidElementType)(source) || !isPlainObject3(source)) {
    return source;
  }
  const output = {};
  Object.keys(source).forEach((key) => {
...
function deepmerge3(target, source, options = {
  ...
  if (isPlainObject3(target) && isPlainObject3(source)) {
    Object.keys(source).forEach((key) => {
      if (React40.isValidElement(source[key]) || (0, import_react_is5.isValidElementType)(source[key])) {
        output[key] = source[key];
...
function createThemeNoVars(options = {}, ...args) {
  ...
  options.generateThemeVars === void 0) {
    throw new Error(true ? "MUI: `vars` is a private field used for CSS variables support.\nPlease use another name or follow the [docs](https://mui.com/material-ui/customization/css-theme-variables/usage/) to enable the feature." : formatMuiErrorMessage3(20));
  }
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AOWJZXVQ.js.map
