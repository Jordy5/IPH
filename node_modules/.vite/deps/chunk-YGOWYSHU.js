...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const element = (0, import_jsx_runtime8.jsxs)(React27.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime8.jsxs)(React27.Fragment, {
...
function createGrid(options = {}) {
  ...
  const NestedContext = React29.createContext(false);
  ...
  const Grid2 = React29.forwardRef(function Grid3(inProps, ref) {
    ...
    const nested = React29.useContext(NestedContext);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YGOWYSHU.js.map
